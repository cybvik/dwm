...
static const int topbar             = 1;        /* 0 means standard bar at 
						   bottom */
static const int extrabar           = 1;        /* 0 means no extra bar */
static const char statussep         = ';';      /* status bar separators */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn",
                                  dmenufont, "-nb", black, "-nf", pink, "-sb",
				  cyan, "-sf", black, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char scratchpadname[] = "calculator";
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-f",
                                       "monospace:size=16", "-g", "50x20",
				       "-e",  "bc", "-ql", NULL };
